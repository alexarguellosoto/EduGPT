...
class Trainer:
    ...
    def train(self):
        ...
        print(
            f"Caracteres cargados: {len(corpus)}"
        )
        ...
        tokens = self.tokenizer.manual_tokenizer(
            cleaned_text
        )
        ...
        print(
            f"Cantidad de IDs: {len(token_ids)}"
        )
        ...
        first_token_id = (
            self.vocabulary.token_to_id[first_token]
        )
        ...
        print(
            "EduGPT ya tiene vocabulario e embeddings."
        )

        print(
            "El entrenamiento de los pesos comenzará "
